...
function getSelectedId(){
	...
	var table=$("#typeTable");
	//2.获得表格对象中选中的id
	var selections=//返回值为一个数组
    //bootstrapTreeTable函数在jquery.treegrid.extension.js中
	table.bootstrapTreeTable("getSelections");
...
function doGetObjects(){
    ...
    //初始化TreeTable,底层会发起异步请求加载数据
	var table=new TreeTable(tableId,
			url, columns);//bootstraptreetable
	//table.setIdField("id");
