...
public class TeamServiceImpl implements TeamService {
	...
	@Override
	public Map<String, Object> findPageObjects(String projectName, Integer pageCurrent) {
		// 1.验证参数的合法性?
		if (pageCurrent == null || pageCurrent < 1)
			throw new ServiceException("pageCurrent的值不合法:pageCurrent" + pageCurrent);
		// 2.计算startIndex的值
		int pageSize = 2;
		...
		// 5.查询当前页数据
		List<Map<String, Object>> list = teamDao.findPageObjects(projectName, startIndex, pageSize);
		// 6.封装分页数据和当前数据
