...
public class AttachmentServiceImpl implements AttachmentService {
	...
	public void uploadObject(String title, MultipartFile mFile) {
		...
		try {
			...
			digest = DigestUtils.md5DigestAsHex(content);
		...
		Attachment attachment = attachmentDao.findObjectByDigest(digest);
	...
	public Map<String, Object> findPageObject(Integer pageCurrent) {
		...
		List<Attachment> list = attachmentDao.findPageObjects(startIndex, pageSize);
		// 6.封装分页及当前页数据
